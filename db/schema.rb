...
ActiveRecord::Schema[7.1].define(version: 2025_12_15_135547) do
  ...
  create_table "apartments", force: :cascade do |t|
    ...
    t.integer "guests"
    t.index ["host_id"], name: "index_apartments_on_host_id"
  end
  ...
  add_foreign_key "apartments", "users", column: "host_id"
