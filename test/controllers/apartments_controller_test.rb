...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { address: @apartment.address, description: @apartment.description, host_id: @apartment.host_id, price: @apartment.price, title: @apartment.title } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, description: @apartment.description, host_id: @apartment.host_id, price: @apartment.price, title: @apartment.title } }
